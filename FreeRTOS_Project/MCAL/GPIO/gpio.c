...
void GPIO_ExternalButton(void){
    /*PB0 -> BLUE
      PB1 -> GREEN
      PB2 -> RED
    */
    GPIO_PORTB_AMSEL_REG &= 0xF7;                        /* Disable Analog on PB 3 */
    GPIO_PORTB_AFSEL_REG &= 0xF7;                        /* Disable alternative function on PB 3 */
    GPIO_PORTB_PCTL_REG  &= 0xFFFF0FFF;                  /* Clear PMCx bits for PB 3 to use as GPIO pins */
    GPIO_PORTB_DIR_REG   &= 0xF7;                        /* Configure PB 3 as input pins */
    GPIO_PORTB_DEN_REG   |= 0x08;                        /* Enable Digital I/O on PB 3 */
    GPIO_PORTB_PUR_REG   |= 0x08;                        /* Enable Pull Up Res on PB 3 */
}
